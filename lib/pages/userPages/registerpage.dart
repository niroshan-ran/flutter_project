...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void preRegisterFunction(UserProvider userProvider, BuildContext context,
      FocusScopeNode node, FirestoreService firestoreService) {
    node.unfocus();
    resetError(false);
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                validator: (value) {
                                  if (value!.isEmpty && !nickNameTextValid) {
                                    return 'This field is a required field';
                                  }
                                  return null;
                                },
                                decoration: InputDecoration(
                                  helperText: 'Type Your Most Friendly Name',
                                  labelText: 'Nick Name',
                                  labelStyle: TextStyle(
                                    color: Color(0xFF2196F3),
                                  ),
                            ...
                            ElevatedButton(
                              onPressed: () => preRegisterFunction(userProvider,
                                  context, node, firestoreService),
                              child: Text("Register"),
                            ),
                            ElevatedButton(
                              onPressed: () {
